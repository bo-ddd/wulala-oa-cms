...
<template>
    ...
    <el-table :data="userTaskList" @cell-click=''  style="width: 100%" class="mb-10">
        ...
        <el-table-column label="操作" align="center" width="200">
            <template #default="scope">
                <!-- <el-button size="small" @click="updateTask(scope.$index, scope.row)" type="danger" plain>编辑</el-button> -->
                <el-button size="small" @click="updateTask(scope.row)" type="danger" plain>任务状态</el-button>
